...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Pelanggan mr= new Bayar();
        Bayar byr= new Bayar();
        Scanner Bayar = new Scanner(System.in);
        System.out.print("Tuliskan Harga: ");
        //menggunakan scanner dan menyimpan apa yang diketik di variabel nama
        byr.bayar= Bayar.nextInt();

        System.out.println("Masukkan berapa bulan membership: ");
        byr.bulan= Bayar.nextInt();



        // Menampilkan apa yang sudah simpan di variabel
        System.out.println("--------------------");
        System.out.println("Harga: " + byr.getBayar());
        System.out.println("Bulan: "+byr.getBulan());
        System.out.println("total: ");
        mr.Uang(byr.getBulan(), byr.getBulan());
